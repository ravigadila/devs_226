"""
Django settings for devs_226 project.
...
WSGI_APPLICATION = "devs_226.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        'NAME': os.getenv("DB_NAME", "devs226"),
